 ...
 *
 * We prefer explicit prop passing, but this context allows wiring the repository at the
 * application root without constructing it in leaf components. Components may still
 * accept a `repository` prop and fall back to this context when the prop is not
 * provided.
 */
 ...
 * @param props.repository - The journal repository instance.
