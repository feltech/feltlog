...
/**
 * Integration tests against the repository using the expo-sqlite-mock shim. Validates
 * that entries can be created and fetched, and that location is undefined when not
 * provided (ensuring nulls from SQLite don't produce a partially-null location
 * object).
 */
